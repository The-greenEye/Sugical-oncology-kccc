      ...
      <footer className="bg-gradient-to-r from-purple-900 to-pink-800 text-white py-12 px-6" data-name="footer" data-file="components/Footer.js">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="mb-8">
            ...
            <h3 className="text-2xl font-bold mb-4">للأستفسار او التسجيل Sayed Salama</h3>
            <a link="tel:51147478" className="text-lg underline hover:text-pink-300 transition-colors duration-300">51147478</a>
          </div>
