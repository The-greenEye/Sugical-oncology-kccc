function OwnerProfile() {
  ...
  const owners = [
    ...
    },
    {
      ...
      title: 'Cheif consultant surgeon',
      image: 'https://up6.cc/2025/10/176441146505462.jpeg',
      description: 'Surgical oncology department',
      description: 'El-Salam Oncology Center. Egypt'
    }
  ];
      ...
      >
        <div className="container mx-auto max-w-6xl">
          ...
          <h4 className="text-2xl font-semibold text-center mb-2 text-[var(--text-primary)]">
            ...
            <center className="text-2xl font-semibold text-center mb-5 mt-5 text-dangerred">Workshop conductors</center>
